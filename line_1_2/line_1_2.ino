...
int singapore[9] = {22, 23, 24, 25, 26, 27, 28, 29, 30};
int cairo[9] = {31, 32, 33, 34, 35, 36, 37, 38, 39};
int istanbul[9] = {40, 41, 42, 43, 44, 45, 46, 47, 48};
...
void cario(String player, int building) {
  if(player == "red"){
