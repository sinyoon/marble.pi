...
int buenosaires[9] = {22, 23, 24, 25, 26, 27, 28, 29, 30};
int busan[3] = {31, 32, 33};
int sao_paulo[9] = {34, 35, 36, 37, 38, 39, 40, 41, 42};
int sydney[9] = {43, 44, 45, 46, 47, 48, 49, 50, 51};
...
void buenisaires(String player, int building) {
  if(player == "red"){
