...
SoftwareSerial MainboardSerial(14, 15);
SoftwareSerial LineSerial(10, 11);

int buenosaires_led[9] = {22, 23, 24, 25, 26, 27, 28, 29, 30};
int busan_led[3] = {31, 32, 33};
int sao_paulo_led[9] = {36, 37, 38, 39, 40, 41, 42, 43, 44};
int sydney_led[9] = {45, 46, 47, 48, 49, 50, 51, 52, 53};
...
void ledOn(String player, String country, int building){
  if(country == "buenosaires"){
    buenosaires(player, building);
  } else if (country == "busan"){
    busan(player);
  } else if(country == "sao_paulo"){
    sao_paulo(player, building);
  } else{
    sydney(player, building);
  }
}

void buenosaires(String player, int building) {
  if(player == "red"){
...
void sao_paulo(String player, int building) {
  if(player == "red"){
...
void sydney(String player, int building){
  if(player == "red"){
