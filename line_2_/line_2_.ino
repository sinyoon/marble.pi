...
int athens[9] = {22, 23, 24, 25, 26, 27, 28, 29, 30};
int concorde[3] = {31, 32, 33};
int copenhagen[9] = {34, 35, 36, 37, 38, 39, 40, 41, 42};
int stockholm[9] = {43, 44, 45, 46, 47, 48, 49, 50, 51};
...
void ledOn(String player, String country, int building){
  if(country == "athens"){
    athens(player, building);
  } else if (country == "concorde"){
    concorde(player);
  } else if(country == "copenhagen"){
    sopenhagen(player, building);
  } else{
    stockholm(player, building);
  }
}

void athens(String player, int building) {
  if(player == "red"){
...
void copenhagen(String player, int building) {
  if(player == "red"){
...
void stockholm(String player, int building){
  if(player == "red"){
